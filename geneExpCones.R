...
filename =""
filename <- paste(mysample, "_coneAvgExpPerSamples.csv", sep="")
...
DotPlot(cones, features = top_gene_list,  col.min = -100, col.max =100,group.by="sample", dot.scale = 8) + RotatedAxis()
dev.off()
